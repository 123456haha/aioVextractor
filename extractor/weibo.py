...
#             results = extract_mobile(response=response_text)
#             return results
#
#     else:
#         cookies = {
...
#             results = extract(response=text, webpage_url=webpage_url)
#             return results
#
#
# def extract(response, webpage_url):
#     try:
...
if __name__ == '__main__':
    ...
    #             # webpage_url="https://weibo.com/tv/v/I4YSOoeCp?fid=1034:4411872741380331",
    #             webpage_url="https://m.weibo.cn/status/4429139631459317?wm=3333_2001&from=109A193010&sourcetype=dingding",
    #             session=session_
    #         )
    #
    #
